...
const handleLinkClick = () => {
  ...
  const toggleTheme = () => {
    ...
    document.documentElement.style.backgroundColor = 
      newTheme === "dark-theme" ? "#1a1a2e" : "#ffffff"; // 👈 add this
  };
  ...
  return (
    <nav className={`navbar navbar-expand-lg fixed-top shadow-sm ${theme === 'dark-theme' ? 'navbar-dark' : 'navbar-light bg-white'}`} ref={navbarRef}>
